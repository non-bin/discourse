...
function applyMode(mode, categories) {
...
export default class extends Component {
  ...
  concatFilteredCategories(categories) {
    this.setFilteredCategories(mode, this.filteredCategories.concat(categories));
  }

  setFetchedCategories(mode, categories) {
    this.setFilteredCategories(applyMode(mode, categories));
  }

  concatFetchedCategories(mode, categories) {
    this.concatFilteredCategories(applyMode(mode, categories));
  }
